...
hi Normal       guifg=#b5c5f0 guibg=#000000   "1a1823
...
if &term == "builtin_gui" || &term == "win32"
	hi Comment		guifg=darkgrey  guibg=#000000 gui=italic
else
	hi Comment		guifg=grey  guibg=#2a233a gui=italic
endif
""""""""""""""""""""""""""""""""""""""""""""""""""""""
...
if &term == "builtin_gui" || &term == "win32"
	...
	hi Comment		ctermfg=grey  ctermbg=darkblue cterm=NONE
	hi IncSearch	ctermfg=yellow ctermbg=darkyellow cterm=NONE
	hi Search	ctermfg=black ctermbg=darkyellow cterm=NONE
endif
""""""""""""""""""""""""""""""""""""""""""""""""""""""
